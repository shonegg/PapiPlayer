...
public class RecyclerViewStateUtils {
     ...
     */
    public static void setFooterViewState(Activity instance, RecyclerView recyclerView, boolean isFirstLoading, LoadingFooter.State state, View.OnClickListener errorListener) {
