...
public abstract class VideoTemplateBaseFragment extends LazyFragment {
    ...
    public VideoTemplateBaseFragment() {
        super();
        this.mCurrentPage = 1;
...
//                view.hide();
//                VideoTemplateBaseFragment.this.mState = STATE.LOADING;
//                VideoTemplateBaseFragment.this.onRequestData();
//            }
//        });
    }
