 ...
 */
public class TopicRecyclerAdapter extends AbsRecyclerViewAdapter {

    private List<TopicBean.VideoInfo> mList = new ArrayList<>();

    public TopicRecyclerAdapter(RecyclerView recyclerView) {
        super(recyclerView);
    }

    public void addContent(List<TopicBean.VideoInfo> list) {
        mList.addAll(list);
    ...
    public TopicBean.VideoInfo getItem(int pos) {
