package com.papi.player.view.fab;
...
import com.papi.player.view.fab.*;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;

public class SimpleFloatingButton extends TextView {
    ...
    public SimpleFloatingButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SimpleFloatingButton(Context context, AttributeSet attrs, int defStyle) {
